...
public class Binary_01 {
	...
	public static void main(String [] args) {
		...
		int result; //연산의 결과값을 저장하는 변수  ** result : 결과
...
//		System.out.println("num1 + num2 = 166" );
		...
		System.out.println("num1 / num2 = " + (num1 / num2));	//나누기 연산자 ->몫(2.66667이 아닌 2)
		System.out.println("num1 % num2 = " + (num1 % num2));	//나머지 연산자 ->나머지
		...
		System.out.println("16.0 / 6.0 = " + (16.0/6.0));	//double/double -> double **이진법으로 처리되어 소수점자리에 오차발생(실수형 태생의 문제)
		
		System.out.println("----------------------");
		
		System.out.println( (double)num1 / (double)num2);	//잠깐만 더블형으로 쓸게요
		
//		System.out.println( (double)16/(double)6);	//변수값 불러오기
//		System.out.println( (double)16.0/(double)6);//왼쪽 항 double형으로 변환
//		System.out.println( 16.0 / 6.0);			//오른쪽 항 double형으로 변환
//		System.out.println( 2.6666666666666665);	//double끼리 나눗셈

		System.out.println("----------------------");
		
		System.out.println( 11 + 34.56 );	// 11의 자동 형변환  *원본 데이터 파괴가 적은 형태로 변환 int < double 
...
//		System.out.println( (double)(16 / 6) );									//형변환 다음 숫자가 나와야하는데 수식이 있어 나눗셈이 우선순위가 됨
