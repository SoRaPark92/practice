...
public class Colllection_07_Properties {
...
//		prop.setProperty("A", 100);
		...
		try {
			...
			writer = new FileWriter("C:\\Users\\TheMKT\\git\\practice\\src\\java10_collection\\user.properties");
		...
		try {
			//파일 입력 스트립 생성
			reader = new FileReader("C:\\Users\\TheMKT\\Desktop\\workspace\\JavaBasic\\src\\java10_collection\\user.properties");
